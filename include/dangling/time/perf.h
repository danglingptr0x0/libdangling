...
LDG_EXPORT double ldg_time_dt_get(ldg_time_ctx_t *ctx);
LDG_EXPORT double ldg_time_dt_smoothed_get(ldg_time_ctx_t *ctx);
LDG_EXPORT double ldg_time_fps_get(ldg_time_ctx_t *ctx);
