...
LDG_EXPORT int32_t ldg_mut_init(ldg_mut_t *m, uint8_t shared);
...
LDG_EXPORT int32_t ldg_mut_trylock(ldg_mut_t *m);
...
LDG_EXPORT int32_t ldg_cond_init(ldg_cond_t *c, uint8_t shared);
LDG_EXPORT void ldg_cond_destroy(ldg_cond_t *c);
LDG_EXPORT void ldg_cond_wait(ldg_cond_t *c, ldg_mut_t *m);
LDG_EXPORT int32_t ldg_cond_timedwait(ldg_cond_t *c, ldg_mut_t *m, uint64_t timeout_ms);
...
LDG_EXPORT int32_t ldg_sem_init(ldg_sem_t *s, const char *name, uint32_t init_val);
LDG_EXPORT int32_t ldg_sem_open(ldg_sem_t *s, const char *name);
LDG_EXPORT void ldg_sem_destroy(ldg_sem_t *s);
LDG_EXPORT void ldg_sem_wait(ldg_sem_t *s);
LDG_EXPORT int32_t ldg_sem_trywait(ldg_sem_t *s);
