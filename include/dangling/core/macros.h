...
#define LDG_CACHE_LINE_WIDTH 64
#define LDG_ALIGNED __attribute__((aligned(LDG_CACHE_LINE_WIDTH)))
#define LDG_ALIGNED_UP(x) (((size_t)(x) + (LDG_CACHE_LINE_WIDTH - 1)) & ~(size_t)(LDG_CACHE_LINE_WIDTH - 1))
#define LDG_ALIGNED_DOWN(x) ((size_t)(x) & ~(size_t)(LDG_CACHE_LINE_WIDTH - 1))
