...
LDG_EXPORT uint32_t ldg_mem_secure_cmp(const void *a, const void *b, size_t len);
LDG_EXPORT void ldg_mem_secure_cmov(void *dst, const void *src, size_t len, int cond);
LDG_EXPORT uint32_t ldg_mem_secure_neq_is(const void *a, const void *b, size_t len);
